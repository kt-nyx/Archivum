...
INSTANCE_OVERVIEW_VOICE = (
    ...
    "what makes it dangerous, stated as concrete fact. Lead with the concrete and stay informative: "
    "name the place's nature, its masters, and the purpose it now serves, and make every sentence "
    "carry a fact the reader did not already have. Keep it high-level — capture the overall arc rather "
    "than chronicling specific events in sequence (name that corruption befell a place, not each "
    "disaster in turn); that granular history belongs in the history sections. Write plainly and "
    "directly, letting strong, specific nouns and verbs do the work; evoke atmosphere through what is "
    "concretely true, not through mood-setting for its own sake. End on a concrete fact, not a "
    "summarizing thesis. Avoid purple flourishes, ornate epithets, and hollow framing sentences that "
    "restate the mood or stakes without adding information — including any closing 'anyone who enters "
    "faces...' / 'to enter is to...' construction (e.g. 'to enter is to step into the lingering "
    "shadow of a ruin that should have been reclaimed'). A full paragraph, but every clause earns its "
    "place. Readable in-universe prose, no walkthrough framing."
)
...
KEY_CHARACTER_VOICE = (
    ...
    "over unrelated later-life events, honors, or offices they hold elsewhere. Cover the full "
    "through-line to their presence here; be concise. "
